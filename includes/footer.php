        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo">VSMS</h2>
              <?php
...
?>
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+254<?php  echo $row['MobileNumber'];?></span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  <?php echo date('Y');?> &copy; VENNITAH SALOON Management System  </p>
          </div>
        </div>
      </div>
    </footer>